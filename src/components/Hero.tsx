...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center pt-20 px-6 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-teal-400/10 to-blue-400/10 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in text-center lg:text-left">
            {/* Enhanced Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-teal-100 to-blue-100 dark:from-teal-900/30 dark:to-blue-900/30 border border-teal-200/50 dark:border-teal-700/50 shadow-sm">
              <Sparkles className="w-4 h-4 text-teal-600 dark:text-teal-400" />
              <span className="text-sm font-semibold text-teal-700 dark:text-teal-300">Available for Projects</span>
            </div>

            <div className="space-y-6">
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-slate-800 dark:text-white leading-tight">
                Hi, I'm{" "}
              ...
              <div className="space-y-4">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl text-slate-700 dark:text-slate-200 font-semibold">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-6 py-4">
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                <div className="w-3 h-3 bg-gradient-to-r from-green-400 to-green-500 rounded-full animate-pulse"></div>
                <span className="text-sm font-medium text-slate-600 dark:text-slate-400">5+ IoT Projects</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                <div className="w-3 h-3 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full animate-pulse delay-300"></div>
                <span className="text-sm font-medium text-slate-600 dark:text-slate-400">Arduino Expert</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                <div className="w-3 h-3 bg-gradient-to-r from-purple-400 to-purple-500 rounded-full animate-pulse delay-500"></div>
                <span className="text-sm font-medium text-slate-600 dark:text-slate-400">Cloud Integration</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                ...
                className="bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 text-white px-8 py-6 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 rounded-xl"
              >
                Let's Connect
              ...
              <Button 
                ...
                variant="outline" 
                className="border-2 border-teal-600/30 bg-white/90 dark:bg-slate-800/90 text-teal-700 dark:text-teal-300 hover:bg-gradient-to-r hover:from-teal-50 hover:to-blue-50 dark:hover:from-teal-900/20 dark:hover:to-blue-900/20 px-8 py-6 text-lg font-semibold backdrop-blur-sm transition-all duration-300 transform hover:scale-105 rounded-xl shadow-sm hover:shadow-lg"
              >
                Download Resume
            ...
            <div className="relative">
              ...
              <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-full bg-gradient-to-br from-teal-400 via-blue-500 to-purple-600 p-1 animate-scale-in shadow-2xl">
                <div className="w-full h-full rounded-full bg-gradient-to-br from-slate-50 to-white dark:from-slate-800 dark:to-slate-700 flex items-center justify-center backdrop-blur-sm">
                  <div className="w-72 h-72 lg:w-88 lg:h-88 rounded-full bg-gradient-to-br from-teal-50 via-blue-50 to-purple-50 dark:from-teal-900/20 dark:via-blue-900/20 dark:to-purple-900/20 flex items-center justify-center shadow-inner border border-white/50 dark:border-slate-600/50">
              ...
              <div className="absolute -top-6 -right-6 w-20 h-20 bg-gradient-to-br from-white to-slate-50 dark:from-slate-700 dark:to-slate-800 rounded-2xl shadow-xl hover:shadow-2xl flex items-center justify-center animate-bounce border border-slate-200/50 dark:border-slate-600/50 transition-all duration-300 hover:scale-110">
                <Code className="w-8 h-8 text-teal-600 dark:text-teal-400" />
              </div>
              
              <div className="absolute top-16 -left-8 w-16 h-16 bg-gradient-to-br from-white to-slate-50 dark:from-slate-700 dark:to-slate-800 rounded-xl shadow-xl hover:shadow-2xl flex items-center justify-center animate-pulse border border-slate-200/50 dark:border-slate-600/50 transition-all duration-300 hover:scale-110">
                <Zap className="w-6 h-6 text-blue-600 dark:text-blue-400" />
              </div>
              
              <div className="absolute bottom-8 -right-10 w-18 h-18 bg-gradient-to-br from-white to-slate-50 dark:from-slate-700 dark:to-slate-800 rounded-2xl shadow-xl hover:shadow-2xl flex items-center justify-center animate-bounce delay-300 border border-slate-200/50 dark:border-slate-600/50 transition-all duration-300 hover:scale-110">
                <span className="text-2xl">🌐</span>
              </div>

              <div className="absolute bottom-16 left-4 w-14 h-14 bg-gradient-to-br from-white to-slate-50 dark:from-slate-700 dark:to-slate-800 rounded-xl shadow-xl hover:shadow-2xl flex items-center justify-center animate-pulse delay-700 border border-slate-200/50 dark:border-slate-600/50 transition-all duration-300 hover:scale-110">
